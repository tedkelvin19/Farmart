        ...
        <div className="maincard">
          ...
          <div id="input-section">
            <ul className="no-bullets">
              <li>
                <input id="boxes" type="text" placeholder="Breed"></input>
              </li>
              <li>
                <input id="boxes" type="text" placeholder="Health"></input>
              </li>
              <li>
                <input
                  id="boxes"
              ...
              <li>
                <input id="boxes" type="text" placeholder="Age"></input>
              </li>
            </ul>
            ...
            <ul className="no-bullets">
              ...
              <li>
                <input id="boxes" type="text" placeholder="Image URL"></input>
              </li>
              <li>
                <input id="boxes" type="text" placeholder="Temperament"></input>
              </li>
              <li>
                <input id="boxes" type="text" placeholder="Cost"></input>
              </li>
            </ul>
          </div>
          <textarea
            id="description"
            placeholder="Describe your animal in less than 150 words"
            rows="4"
            cols="48"
          ></textarea>
